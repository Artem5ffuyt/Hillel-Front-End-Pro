...
Hайти гласные
Мы хотим знать индекс гласных в данном слове, например, в World супер две гласные 
(вторая и четвертая).Итак, учитывая строку «super», мы должны вернуть список [2,4]*/

 function voweLIndices(word){
    const vowels = (aeiouAEIOU)
    const res = []
    for(i = 0; word.lench; i++){
